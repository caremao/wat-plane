...
class WhatsThatPlaneConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        data_schema = vol.Schema({
            ...
            vol.Optional("distance_units", default=DISTANCE_IMPERIAL): vol.In(
                [DISTANCE_METRIC, DISTANCE_IMPERIAL]),
            vol.Optional("altitude_units", default=ALTITUDE_IMPERIAL): vol.In(
                [ALTITUDE_METRIC, ALTITUDE_IMPERIAL]),
            vol.Optional("speed_units", default=SPEED_IMPERIAL): vol.In(
                [SPEED_METRIC, SPEED_IMPERIAL]),
        })
    ...
    async def async_step_init(self, user_input=None):
        ...
        options_schema = vol.Schema({
            ...
            vol.Optional("distance_units",
                         default=current_config.get("distance_units", DISTANCE_IMPERIAL)): vol.In(
                [DISTANCE_METRIC, DISTANCE_IMPERIAL]),
            vol.Optional("altitude_units",
                         default=current_config.get("altitude_units", ALTITUDE_IMPERIAL)): vol.In(
                [ALTITUDE_METRIC, ALTITUDE_IMPERIAL]),
            vol.Optional("speed_units",
                         default=current_config.get("speed_units", SPEED_IMPERIAL)): vol.In(
                [SPEED_METRIC, SPEED_IMPERIAL]),
        })
